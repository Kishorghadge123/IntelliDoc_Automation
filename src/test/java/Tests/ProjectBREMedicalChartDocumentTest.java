...
public class ProjectBREMedicalChartDocumentTest extends BasePage {
    ...
    public void ProjectBREMedicalChartDocumentFlow() throws InterruptedException, IOException {
        try {
            ...
            Thread.sleep(2000);
            ProjectBREMedicalChartDocumentPageObj.ClickOnEnterStarDate(ReadProps.readAttr("StartDate"));
            Thread.sleep(2000);
            ProjectBREMedicalChartDocumentPageObj.ClickOnEnterEndDate(ReadProps.readAttr("EndDate"));
            Thread.sleep(2000);

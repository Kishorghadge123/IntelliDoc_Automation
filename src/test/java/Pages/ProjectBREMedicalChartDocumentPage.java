...
public class ProjectBREMedicalChartDocumentPage {
    ...
    By EditEncounterDetails = By.xpath("//mat-icon[contains(text(),'create')]");
    ...
    public void ClickOnClearAddress() {driver.findElement(Address).clear();}
    public void ClickOnEnterAddress(String text){ driver.findElement(Address).sendKeys(text);}
    public void ClickOnSaveDraft() {driver.findElement(SaveDraft).click();}
    public void ClickOnChronicConditions() {driver.findElement(ChronicConditions).click();}
    public void ClickOnAddChronicCondition() {driver.findElement(AddChronicCondition).click();}
    ...
    public void ClickOnEnterStarDate(String text){ driver.findElement(StartDate).sendKeys(text);}

    public void ClickOnEnterEndDate(String text){ driver.findElement(EndDate).sendKeys(text);}
    public void ClickOnSaveChronicCondition() {driver.findElement(SaveBtn).click();}
    public void ClickOnCancelChronicCondition() {driver.findElement(CancelCC).click();}
    public void ClickOnAddedChronicCondition() {driver.findElement(ClickAddedChronicCondition).click();}
    public void ClickOnDeleteChronicCondition() {driver.findElement(DeleteCC).click();}
    public void ClickOnEditChronicCondition() {driver.findElement(EditEncounterDetails).click();}
    public void ClickOnSaveEditEncounterDetails() {driver.findElement(SaveEditEncounterDetails).click();}
    public void ClickOnCancelEditEncounterDetails() {driver.findElement(CancelEditEncounterDetails).click();}
    public void ClickOnAddDiagnosisDetails() {driver.findElement(AddDiagnosisDetails).click();}

    public void ClickOnCancelDiagnosisDetails() {driver.findElement(CancelDiagnosisDetails).click();}
    public void ClickOnSaveDiagnosisDetails() {driver.findElement(SaveDiagnosisDetails).click();}
